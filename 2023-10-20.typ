...
$ EE[l_c] - H_D (Chi) = sum_(x in Chi) p(x) l_c (x) - sum_(x in Chi)^m p(x) log_D 1 / p(x) $ $ = sum_(x in Chi) p(x) dot (l_c (x) - log_D 1 / p(x)) = sum_(x in Chi) p(x) dot (log_D D^(l_c (x)) - log_D 1 / p(x)) $ $ = sum_(x in Chi) p(x) dot (log_D D^(l_c (x)) + log_D p(x)) = sum_(x in Chi) p(x) log_D ( D^(l_c (x)) dot p(x)) $ $ = sum_(x in Chi) p(x) dot (log_D (p(x)) / (D^(-l_c (x))) dot 1) = sum_(x in X) p(x) dot (log_D (p(x) / (D^(-l_c (x))) dot (sum_(x' in Chi) D^(-l_c (x'))) / (sum_(x' in Chi) D^(-l_c (x')))))  $ $ = sum_(x in Chi) p(x) dot (log_D p(x) (sum_(x' in Chi) D^(-l_c (x'))) / (D^(-l_c (x))) - log_D sum_(x' in Chi) D^(-l_c (x'))) $ $ = sum_(x in Chi) p(x) dot (log_D p(x) / q(x) - log_D sum_(x' in Chi) D^(-l_c (x'))) $ $ = sum_(x in Chi) p(x) log_D p(x) / q(x) - p(x) log_D sum_(x' in Chi) D^(-l_c (x')) $ $ = sum_(x in Chi) p(x) log_D p(x) / q(x) - sum_(x in Chi) p(x) log_D sum_(x' in Chi) D^(-l_c (x')) $ $ = underbracket(Delta(Chi bar.v.double ZZ), gt.eq 0) underbracket(- underbracket(log_D sum_(x' in Chi) D^(-l_c (x')), "c istantaneo" arrow "vale kraft" <= 1), gt.eq 0 "logaritmo") dot underbracket(sum_(x in Chi) p(x), =1) gt.eq 0 $
]
